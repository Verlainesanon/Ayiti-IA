"""
Constructeur de dataset Ayiti-AI.
...
class AyitiDatasetBuilder:
    """
    Constructeur de dataset pour Ayiti-AI.

    Lit les fichiers JSONL dans raw_path, nettoie le texte,
    et produit un Dataset HuggingFace exporté en Parquet.
    """
    ...
    def clean_text(self, text: str) -> str:
        ...
        et en normalisant les espaces. Préserve les accents créoles/français.
        """
    ...
    def build_train_dataset(self) -> Dataset:
        """
        Construit le dataset d'entraînement depuis les fichiers bruts.

        Returns:
            Dataset HuggingFace nettoyé, sauvegardé en Parquet.
        """
    ...
    def build_tokenizer_corpus(self) -> str:
        """
        Construit un corpus texte brut pour l'entraînement du tokenizer.

        Returns:
            Chemin du fichier corpus généré.
        """
        raw_data = self.load_raw_files()
        texts = []
        for item in raw_data:
